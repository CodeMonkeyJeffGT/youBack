 ...
 */
final class Version20190429052324 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `column` (id INT AUTO_INCREMENT NOT NULL, school_id INT DEFAULT NULL, owner_id INT NOT NULL, name VARCHAR(20) NOT NULL, description VARCHAR(255) NOT NULL, type INT NOT NULL, created DATETIME NOT NULL, UNIQUE INDEX UNIQ_7D53877E5E237E06 (name), INDEX IDX_7D53877EC32A47EE (school_id), INDEX IDX_7D53877E7E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE follow_column ADD CONSTRAINT FK_56F2390685289D43 FOREIGN KEY (acolumn_id) REFERENCES `column` (id)');
        ...
        $this->addSql('ALTER TABLE page ADD CONSTRAINT FK_140AB62085289D43 FOREIGN KEY (acolumn_id) REFERENCES `column` (id)');
        ...
        $this->addSql('ALTER TABLE `column` ADD CONSTRAINT FK_7D53877EC32A47EE FOREIGN KEY (school_id) REFERENCES school (id)');
        $this->addSql('ALTER TABLE `column` ADD CONSTRAINT FK_7D53877E7E3C61F9 FOREIGN KEY (owner_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE message ADD CONSTRAINT FK_B6BD307FA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE message ADD CONSTRAINT FK_B6BD307FF624B39D FOREIGN KEY (sender_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE report ADD CONSTRAINT FK_C42F7784A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE column_classification ADD CONSTRAINT FK_9A26D3E0E190556B FOREIGN KEY (column_owned_id) REFERENCES `column` (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `column` DROP FOREIGN KEY FK_7D53877EC32A47EE');
        ...
        $this->addSql('ALTER TABLE `column` DROP FOREIGN KEY FK_7D53877E7E3C61F9');
