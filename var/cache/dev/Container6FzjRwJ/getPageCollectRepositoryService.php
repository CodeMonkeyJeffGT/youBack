...
// Returns the private 'App\Repository\PageCollectRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PageCollectRepository.php';

return $this->privates['App\Repository\PageCollectRepository'] = new \App\Repository\PageCollectRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
