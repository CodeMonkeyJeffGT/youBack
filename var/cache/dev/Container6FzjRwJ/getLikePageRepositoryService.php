...
// Returns the private 'App\Repository\LikePageRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LikePageRepository.php';

return $this->privates['App\Repository\LikePageRepository'] = new \App\Repository\LikePageRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
