...
// Returns the private 'App\Repository\MenuUserRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/MenuUserRepository.php';

return $this->privates['App\Repository\MenuUserRepository'] = new \App\Repository\MenuUserRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
