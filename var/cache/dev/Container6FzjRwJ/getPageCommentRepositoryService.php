...
// Returns the private 'App\Repository\PageCommentRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PageCommentRepository.php';

return $this->privates['App\Repository\PageCommentRepository'] = new \App\Repository\PageCommentRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
