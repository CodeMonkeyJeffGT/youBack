...
// Returns the private 'App\Repository\FollowUserRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FollowUserRepository.php';

return $this->privates['App\Repository\FollowUserRepository'] = new \App\Repository\FollowUserRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
