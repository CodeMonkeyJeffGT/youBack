...
// Returns the private 'App\Repository\ColumnRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ColumnRepository.php';

return $this->privates['App\Repository\ColumnRepository'] = new \App\Repository\ColumnRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
