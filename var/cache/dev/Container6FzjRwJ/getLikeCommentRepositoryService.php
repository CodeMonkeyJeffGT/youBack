...
// Returns the private 'App\Repository\LikeCommentRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LikeCommentRepository.php';

return $this->privates['App\Repository\LikeCommentRepository'] = new \App\Repository\LikeCommentRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
