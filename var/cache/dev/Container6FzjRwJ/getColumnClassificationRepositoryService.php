...
// Returns the private 'App\Repository\ColumnClassificationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ColumnClassificationRepository.php';

return $this->privates['App\Repository\ColumnClassificationRepository'] = new \App\Repository\ColumnClassificationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
