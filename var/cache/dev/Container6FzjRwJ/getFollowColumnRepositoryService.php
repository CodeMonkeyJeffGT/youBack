...
// Returns the private 'App\Repository\FollowColumnRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FollowColumnRepository.php';

return $this->privates['App\Repository\FollowColumnRepository'] = new \App\Repository\FollowColumnRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
